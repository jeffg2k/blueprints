...
public class GEXFReader {
    ...
    private String edgeLabelKey = GEXFTokens.LABEL;
    ...
    /**
     * @param vertexIdKey GEXF property to use as id for verticies
     */
    ...
    /**
     * @param edgeIdKey GEXF property to use as id for edges
     */
    ...
    /**
     * @param edgeLabelKey GEXF property to assign edge Labels to
     */
    ...
    public static void inputGraph(final Graph inputGraph, final InputStream inputStream, final int bufferSize,
        ...
        try {
            new GEXFParser(graph, defaultEdgeLabel, vertexIdKey, edgeIdKey, edgeLabelKey).parse(reader);
            graph.stopTransaction(TransactionalGraph.Conclusion.SUCCESS);
        } catch (Exception e) {
            throw new IOException("GEXF malformed", e);
        }
    }
